...
class GUI:
    def __init__(self):
        ...
        url_label = tk.Label(self.root, text="Enter URL:", font=("Helvetica", 16))
        url_label.pack(padx=8, pady=8)
        self.url_entry = tk.Entry(self.root, font=("Helvetica", 14))
        self.url_entry.pack(padx=8, pady=8)

        download_button = tk.Button(self.root, text="Download", font=("Helvetica", 16), bg="#007acc", fg="white", padx=10,
                                    pady=5, command=self.download)
        download_button.pack(padx=8, pady=8)
